...
export default async function NewsDetailPage({
  ...
  return (
    <div className="pt-28 pb-20 px-6 max-w-3xl mx-auto">
      ...
      <h1 className="font-serif text-3xl font-light mb-8">{title}</h1>
      ...
      {item.link && (
        <a
          ...
          className="inline-block mt-8 font-sans text-[11px] tracking-widest uppercase border-b border-current pb-0.5 hover:opacity-60 transition-opacity"
        >
          {t("press.readMore")} →
        </a>
      )}
